...
public class ExprParser extends Parser {
	...
	public static final int
		RULE_prog = 0, RULE_expr = 1, RULE_declaration = 2, RULE_assignment = 3, 
		RULE_type = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"prog", "expr", "declaration", "assignment", "type"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 16130L) != 0)) {
				{
				setState(13);
				_errHandler.sync(this);
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ButtercupExprContext extends ExprContext {
		...
		public ButtercupExprContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ExprListener ) ((ExprListener)listener).enterButtercupExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ExprListener ) ((ExprListener)listener).exitButtercupExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExprVisitor ) return ((ExprVisitor<? extends T>)visitor).visitButtercupExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case T__0:
				{
				_localctx = new ButtercupExprContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
